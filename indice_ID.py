...
def criar_e_pesquisar_indice_campo1(arquivo_binario, tamanho_registro, valor_pesquisa):
    indice_campo1 = {}
    registros = []

    def criar_indice_campo1():
        nonlocal registros
        ...
        for i, registro in enumerate(registros):
            ...
            if len(campos) == tamanho_registro // 100:
                valor_campo1 = campos[0].strip()  

                if valor_campo1 not in indice_campo1:
                    indice_campo1[valor_campo1] = []

                indice_campo1[valor_campo1].append(i) 

        with open("indice_ID.bin", "wb") as index_file:
            for key, value in indice_campo1.items():
    ...
    def pesquisar_indice_campo1(valor_pesquisa):
        with open("indice_ID.bin", "rb") as index_file:
            while True:
    ...
    pesquisar_indice_campo1(valor_pesquisa)

arquivo_binario = "reduzido.bin"
tamanho_registro = 600  
valor_pesquisa = "33"
criar_e_pesquisar_indice_campo1(arquivo_binario, tamanho_registro, valor_pesquisa)
